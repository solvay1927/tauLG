...
``For a collection of $N$ momenta $\mathbf{p}_i$ ($i = 1,\ldots, N$), the thrust axis $\mathbf{T}$ is defined as the unit vector along which their total projection is maximal; the thrust scalar $T$ (or thrust) is a derived quantity defined as
\begin{equation}
